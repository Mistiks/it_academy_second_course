...
import dao.hibernate.FlightHibernate;
...
public class SearchServlet extends HttpServlet {
    ...
    /** Instance of IFlightAccess interface */
    private final IFlightAccess<Flight> tableAccess;

    /** Default constructor which defines ITableAccess interface */
    public SearchServlet() {
        this.tableAccess = FlightHibernate.getInstance();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.removeAttribute("flightsList");
        int page;
